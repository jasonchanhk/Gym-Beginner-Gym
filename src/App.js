    ...
    <BrowserRouter>
      <div className="App">
            ...
            <Switch>
                ...
                <Route path="/nutrition" exact component={() => <Nutrition nutritionStat={nutritionStat} setStatInput={setStatInput} statInput={statInput}  />} />
                <Route path="/workout" exact component={() => <Workout exercises={exercises} />} />
                <Route path="/gymnearby" exact component={() => <Gym />} />
                <Redirect to="/home" />
            </Switch>
            <Footer />
      </div>
