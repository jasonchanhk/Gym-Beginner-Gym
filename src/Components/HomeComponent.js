            ...
            <Container className="text-start">                
                ...
                <Row>
                    <Col lg="7" className="mb-5">
                        ...
                        <Button variant="warning" type="button" href="/workout" className="orangebg">Checkout What Barbell Can Do</Button>
                    </Col>
                    <Col lg="5">
                        <img
                        className="d-block"
                ...
                <Row>                    
                    ...
                    <Col lg="7" >
                        ...
                        <Button variant="warning" type="button" href="/nutrition" className="orangebg">Try Calculate Your TDEE</Button>
                    </Col>
                </Row>
                <hr className="my-5"/>
                <Row className="mb-5">
                    <Col lg="7" className="mb-5">
                        ...
                        <Button variant="warning" type="button" href="/gymnearby" className="orangebg">Find the GBG GYM near you</Button>
                    </Col>
                    <Col lg="5">
                        <img
                        className="d-block"
